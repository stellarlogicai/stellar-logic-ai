...
async function testServiceAccountEmailV4() {
  console.log('🔧 Testing Stellar Logic AI Service Account Email Service v4...\n');
  ...
  try {
    ...
    const result = await emailService.sendEmail(
      testEmail,
      'Stellar Logic AI - Service Account Test v4',
      `
        <h2>🚀 Service Account Email Test Successful!</h2>
        <p>Your Stellar Logic AI email service is working correctly with Service Account v4.</p>
    ...
    await emailService.sendInvestorUpdate(
      testEmail,
      'Quarterly',
      'Test investor update v4: Your Stellar Logic AI investment is performing well with Service Account v4.'
    );
    ...
    await emailService.sendCustomerFollowUp(
      testEmail,
      'Demo Follow-up',
      'Test customer follow-up v4: Thank you for your interest in Stellar Logic AI v4. Here are the next steps for integration.'
    );
    ...
    console.log('\n🎉 All tests passed! Your AI assistant is ready with Service Account v4!');
    ...
    console.log('\n🔧 Troubleshooting:');
    console.log('1. Make sure service-account-key-v4.json exists in ./credentials/');
...
// Run the test
testServiceAccountEmailV4().catch(console.error);
